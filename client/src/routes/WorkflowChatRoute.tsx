...
import WorkflowChatView from '~/components/WorkflowChat/WorkflowChatView';
...
export default function WorkflowChatRoute() {
  ...
  useEffect(() => {
    ...
    if (conversationId === Constants.NEW_CONVO && endpointsQuery.data && modelsQuery.data) {
      ...
      logger.log('conversation', 'WorkflowChatRoute, new convo effect', conversation);
      newConversation({
      ...
      logger.log('conversation', 'WorkflowChatRoute initialConvoQuery', initialConvoQuery.data);
      newConversation({
      ...
      const spec = getDefaultModelSpec(startupConfig);
      logger.log('conversation', 'WorkflowChatRoute new convo, assistants effect', conversation);
      newConversation({
        modelsData: modelsQuery.data,
        template: conversation ? conversation : undefined,
        ...(spec ? { preset: getModelSpecPreset(spec) } : {}),
      ...
      logger.log('conversation', 'WorkflowChatRoute convo, assistants effect', initialConvoQuery.data);
      newConversation({
        template: initialConvoQuery.data,
        preset: initialConvoQuery.data as TPreset,
        modelsData: modelsQuery.data,
